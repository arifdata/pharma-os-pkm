...
| **Backend** | PocketBase 0.39.10 (single binary, SQLite) |
...
- [PocketBase](https://github.com/pocketbase/pocketbase/releases/tag/v0.38.2) v0.39.10 binary di root project (gitignored)
...
# 2. Download PocketBase v0.39.10
